...
func GetAllScheduler() (data map[string]map[string]string, err error) {
	...
	for rows.Next() {
		...
		if allScheduleDetails[uniqid] == nil {
			allScheduleDetails[uniqid] = map[string]string{}
		}
...
func GetSchedulerLogByUniqueid(uuid string) (data map[string]map[string]string, err error) {
	...
	for rows.Next() {
		...
		if allScheduleLogDetails[uniqid] == nil {
			allScheduleLogDetails[uniqid] = map[string]string{}
		}
