...
func PingServiceMaster() (err error) {
  ...
  if _, err := os.Stat(dstPath + file); os.IsNotExist(err) {
    ...
    logs.Info("github.com/OwlH-net/OwlH-Master service already exists")
    return nil
  }
}
...
func DeployServiceMaster() (err error) {
  ...
  if _, err := os.Stat(dstPath + file); os.IsNotExist(err) {
    ...
    // //return nil
    logs.Info("github.com/OwlH-net/OwlH-Master service deployed successfully!")
    return nil
  } else {
    logs.Info("github.com/OwlH-net/OwlH-Master service already exists")
    return nil
...
func PingPlugins() (data map[string]map[string]string, err error) {
  ...
  if err != nil {
    logs.Error("ping/PingPlugins checking tcpdump: " + err.Error())
  }
  ...
  if err != nil {
    logs.Error("ping/PingPlugins checking socat: " + err.Error())
  }
  if len(checkSocat) > 0 {
...
func GetGroupFile(data map[string]string) (content map[string]string, err error) {
  ...
  if err != nil {
    logs.Error("GetPathFileContent Error reading file for path: " + data["file"])
    return nil, err
  }
...
func GetFileContentByType(data map[string]string) (values map[string]string, err error) {
  ...
  case "group":
    ...
    if err != nil {
      logs.Error("GetFileContentByType Error - " + err.Error())
      return nil, err
    }
  case "node":
    logs.Info("TODO")
...
func SaveNewFileContent(data map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("SaveNewFileContent ERROR: " + err.Error())
    return err
  }
...
func AddUser(data map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("master/AddUser Error inserting ldap into db: " + err.Error())
    return err
  }

  err = ndb.InsertUser(uuid, "type", data["type"])
  if err != nil {
    logs.Error("master/AddUser Error inserting type into db: " + err.Error())
    return err
  }

  err = ndb.InsertUser(uuid, "userTokens", "")
  if err != nil {
    logs.Error("master/AddUser Error inserting userToken into db: " + err.Error())
    return err
  }
...
func ChangePassword(anode map[string]string) (err error) {
  ...
  if anode["user"] != "" && anode["current"] != "" && anode["new"] != "" && anode["again"] != "" {
    ...
    if anode["new"] == anode["again"] {
      ...
      if err != nil {
        logs.Error("master/ChangePassword Error getting users data: " + err.Error())
        return err
      }
      ...
      if err != nil {
        logs.Error("master/ChangePassword Passwords are not equals: " + err.Error())
        return err
      }
...
func GetAllRulesetsForAllNodes() (data map[string]map[string]string, err error) {
  ...
  for id := range allNodes {
    ...
    if err != nil {
      logs.Error("GetAllRulesetsForAllNodes Error loading node token: %s", err)
      return nil, err
    }
    nodeRsets, err := nodeclient.GetSuricataRulesets(allNodes[id]["ip"], allNodes[id]["port"])
    if err != nil {
      logs.Error("GetAllRulesetsForAllNodes Error getting node rulesets from suricata: %s", err)
      return nil, err
    }
...
func AddOrganization(anode map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("master/AddOrganization Error checking new organization: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("master/AddOrganization Error adding organization name: " + err.Error())
    return err
  }
  err = ndb.InsertOrganization(uuid, "desc", anode["desc"])
  if err != nil {
    logs.Error("master/AddOrganization Error adding organization desc: " + err.Error())
    return err
  }
  err = ndb.InsertOrganization(uuid, "default", anode["default"])
  if err != nil {
    logs.Error("master/AddOrganization Error adding organization default status: " + err.Error())
    return err
  }
...
func GetAllOrganizationNodes(orgID string) (data map[string]string, err error) {
  ...
  if err != nil {
    logs.Error("master/GetAllOrganizationNodes Error getting nodeOrgs: " + err.Error())
    return nil, err
  }
  nodes, err := ndb.GetAllNodes()
  if err != nil {
    logs.Error("master/GetAllOrganizationNodes Error getting nodes: " + err.Error())
    return nil, err
  }
