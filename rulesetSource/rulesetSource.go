...
func CreateRulesetSource(n map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("CreateRulesetSource Error getting data from main.conf for load data: " + err.Error())
    return err
  }
...
func CreateCustomRulesetSource(n map[string]string) (err error) {
  ...
  if n["url"] != "" {
    ...
    for key, value := range n {
      ...
      if err != nil {
        return errors.New("Error adding existing custom rule file data into database.")
      }
    }

    md5, err := utils.CalculateMD5(n["url"])
    if err != nil {
      return errors.New("Error Checking MD5 for CreateCustomRulesetSource.")
    }
    ...
    if err != nil {
      return errors.New("Error adding existing custom rule file data to database.")
    }

  } else {
    path, err := utils.GetKeyValueString("ruleset", "customRulesets")
    if err != nil {
      logs.Error("CreateCustomRulesetSource Error getting data from main.conf: " + err.Error())
      return err
    }
    ...
    if _, err := os.Stat(path); os.IsNotExist(err) {
      ...
      if err != nil {
        logs.Error("Error checking path: " + err.Error())
        return err
      }
    }
...
func GetAllRulesetSource(hasPermissions bool) (sources map[string]map[string]string, err error) {
  ...
  for uuidRows.Next() {
    ...
    for rows.Next() {
      ...
      if allsources[uniqid] == nil {
        allsources[uniqid] = map[string]string{}
      }
...
func DeleteRulesetFile(uuid string) (err error) {
  ...
  if err != nil {
    logs.Error("ndb.Rdb.Query Error checking if ruleset is local: %s", err.Error())
    return err
  }
  for id := range allRuleFiles {
    if uuid == id && allRuleFiles[id]["type"] == "local" {
      isLocal = true
    }
  }
...
func DeleteRulesetSource(anode map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("DeleteRulesetSource Error getting data from main.conf: " + err.Error())
    return err
  }
...
func EditRulesetSource(data map[string]string) (err error) {
  ...
  for k, v := range data {
    if k == "sourceuuid" {
      ...
      if err != nil {
        logs.Error("EditRulesetSourceError updating ruleset source data")
        return err
      }
  ...
  for x := range ruleFiles {
    ...
    if err != nil {
      logs.Error("EditRulesetSource Error updating rule_files data after update a ruleset")
      return err
    }
  }
...
func OverwriteDownload(data map[string]string) (err error) {
  ...
  pathDownloaded, err := utils.GetKeyValueString("ruleset", "sourceDownload")
  if err != nil {
    logs.Error("OverwriteDownload Error getting data from main.conf: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("OverwriteDownload Error getting ruleset data: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("DownloadFile ERROR: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("Error updating path OverwriteDownload: " + err.Error())
    return err
  }
  err = ndb.UpdateRuleset(data["uuid"], "url", data["url"])
  if err != nil {
    logs.Error("Error updating url OverwriteDownload: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("Error getting map with new files downloaded OverwriteDownload: " + err.Error())
    return err
  }
  ...
  if err != nil {
    logs.Error("Error creating map OverwriteDownload: " + err.Error())
    return err
  }
  ...
  for w := range newFilesDB {
    ...
    if newFilesDB[w]["count"] == "1" {
      ...
      err = ndb.InsertRulesetSourceRules(uuid, "md5", md5)
      if err != nil {
        logs.Error("Error inserting rules into ruleset source OverwriteDownload: " + err.Error())
        return err
      }
    }
  }
...
func DownloadFile(data map[string]string) (err error) {
  ...
  if _, err := os.Stat(pathDownloaded + pathSelected); os.IsNotExist(err) {
    ...
    for k, _ := range ruleFiles["files"] {
      ...
      err = ndb.InsertRulesetSourceRules(uuid, "md5", md5)
      if err != nil {
        logs.Error("DownloadFile Error from InsertRulesetSourceRules: " + err.Error())
        return err
      }
    }
...
func CompareFiles(uuid string) (mapData map[string]map[string]string, err error) {
  ...
  if err != nil {
    logs.Error("CompareFiles Error comparing files: " + err.Error())
    return nil, err
  }
  ...
  if err != nil {
    logs.Error("CompareFiles MapFromFile for origFile failed: %s", err)
    return nil, err
  }
  fileDst, err := utils.MapFromFile(rulesetPath)
  if err != nil {
    logs.Error("CompareFiles MapFromFile for fileDst failed: %s", err)
    return nil, err
  }
...
func CreateNewFile(data map[string]string) (err error) {
  ...
  if err != nil {
    logs.Error("CreateNewFile Error getting data from main.conf: " + err.Error())
    return err
  }
...
func Details(data map[string]string) (files map[string]map[string]string, err error) {
  pathDownloaded, err := utils.GetKeyValueString("ruleset", "sourceDownload")
  if err != nil {
    logs.Error("Details Error getting data from main.conf: " + err.Error())
    return nil, err
  }
...
func GetDetails(uuid string) (data map[string]map[string]string, err error) {
  ...
  for x := range dbFiles {
    ...
    if err != nil {
      logs.Error("GetDetails ndb.UpdateRuleFiles Error : %s", err.Error())
      return nil, err
    }
    ...
    if err != nil {
      logs.Error("GetDetails ndb.GetRuleFilesByUniqueid Error : %s", err.Error())
      return nil, err
    }
    ...
    for n := range sourceFile {
      ...
      if md5S1 != md5S {
        ...
        if err != nil {
          logs.Error("GetDetails Error updating after compare md5 GetDetails: %s", err.Error())
          return nil, err
        }
        ...
        if err != nil {
          logs.Error("GetDetails Error creating map from source file: %s", err.Error())
          return nil, err
        }

        fileDst, err := utils.MapFromFile(dbFiles[x]["path"]) //son file
        if err != nil {
          logs.Error("GetDetails Error creating map from file: %s", err.Error())
          return nil, err
        }
        ...
        for q := range fileOrig {
          ...
          if !linesAreAdded {
            ...
            if err != nil {
              logs.Error("GetDetails Error updating after compare lines added: %s", err.Error())
              return nil, err
            }
            break
          }
...
func OverwriteRuleFile(uuid string) (err error) {
  ...
  for r := range dbFiles {
    ...
    for t := range sourceFile {
      ...
      if err != nil {
        logs.Error("OverwriteRuleFile failed backing up file: %s", err)
        return err
      }
...
func AddNewLinesToRuleset(uuid string) (err error) {
  ...
  if err != nil {
    logs.Error("AddNewLinesToRuleset GetRuleFilesByUniqueid error: %s", err)
    return err
  }
  ...
  for w := range rulesetFile { //son
    for s := range sourceFile { //father
      ...
      if err != nil {
        logs.Error("Error updating sourceFile after compare md5 AddNewLinesToRuleset: %s", err.Error())
        return err
      }
      ...
      err = ndb.UpdateRuleFiles(s, "md5", md5Father)
      if err != nil {
        logs.Error("Error updating sourceFile after compare md5 AddNewLinesToRuleset: %s", err.Error())
        return err
      }
      err = ndb.UpdateRuleFiles(w, "md5", md5Son)
      if err != nil {
        logs.Error("Error updating sourceFile after compare md5 AddNewLinesToRuleset: %s", err.Error())
        return err
      }
      err = ndb.UpdateRuleFiles(w, "linesAdded", "true")
      if err != nil {
        logs.Error("Error updating linesAdded AddNewLinesToRuleset: %s", err.Error())
        return err
      }
    }
  }
...
func LoadDefaultRulesets() (mapData map[string]map[string]string, err error) {
  ...
  if err != nil {
    logs.Error("LoadDefaultRulesets Details Error getting data from main.conf: " + err.Error())
    return nil, err
  }

  content, err := ioutil.ReadFile(defaultPath)
  if err != nil {
    logs.Error("LoadDefaultRulesets Error readding default rulesets file: " + err.Error())
    return nil, err
  }
